...
public class SlimIconPackPreference extends IconPackPreference {

    public SlimIconPackPreference(Context context) {
        super(context, null);
    }

    public SlimIconPackPreference(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
    }

    public SlimIconPackPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    /**
     * This method overrides Preference method so to store the information
     * inside SLIM_RECENTS_ICON_PACK.
     *
    ...
    public boolean persistString(String value) {
        return Settings.System.putString(getContext().getContentResolver(),
                Settings.System.SLIM_RECENTS_ICON_PACK, /* packageName */ value);
    }

    /**
     * This method overrides Preference method so to get the information
     * from SLIM_RECENTS_ICON_PACK.
     *
     * @param value the default value to return if SLIM_RECENTS_ICON_PACK is not available.
